...
public class ManagedExecutorDefinitionAnnotationProcessor extends ResourceDefinitionAnnotationProcessor {
    ...
    private static final DotName MANAGEC_EXECUTOR_DEFINITION_LIST = DotName.createSimple(ManagedExecutorDefinition.List.class.getName());
    ...
    protected DotName getAnnotationCollectionDotName() {
        return MANAGEC_EXECUTOR_DEFINITION_LIST;
    }
