...
public class ResteasyExtensionTransformerRegistration implements ExtensionTransformerRegistration {
    ...
    public void registerTransformers(final SubsystemTransformerRegistration subsystemRegistration) {
        ...
        registerV1Transformers(builder.createBuilder(VERSION_2_0_0, VERSION_1_0_0));

        builder.buildAndRegister(subsystemRegistration, new ModelVersion[] {VERSION_1_0_0, VERSION_2_0_0, VERSION_3_0_0, JaxrsExtension.CURRENT_MODEL_VERSION});
    }
    ...
    private static void registerV1Transformers(ResourceTransformationDescriptionBuilder subsystem) {
        subsystem.getAttributeBuilder()
                .setDiscard(DiscardAttributeChecker.DEFAULT_VALUE, JaxrsAttribute.ATTRIBUTES)
                .addRejectCheck(RejectAttributeChecker.DEFINED, JaxrsAttribute.ATTRIBUTES);
    }
}
