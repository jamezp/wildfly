...
@RunAsClient
public class JBossLoggingConfigLogRouterTestCase extends AbstractLogRouterTest {
    private static final String DEPLOYMENT_1 = "test-jbl-config-logging-1.war";
    private static final String DEPLOYMENT_2 = "test-jbl-config-logging-2.war";
    private static final String DEP1_SUFFIX = "jb-test-dep-1";
    private static final String DEP2_SUFFIX = "jb-test-dep-2";
    private static final String DEP1_FILE_NAME = "jb-test1-json.log";
    private static final String DEP2_FILE_NAME = "jb-test2-json.log";

    public JBossLoggingConfigLogRouterTestCase() {
