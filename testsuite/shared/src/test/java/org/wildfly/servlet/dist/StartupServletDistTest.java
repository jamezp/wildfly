...
/**
 * Tests starting the servlet distribution
 *
 * @author <a href="mailto:jperkins@redhat.com">James R. Perkins</a>
 */
@SuppressWarnings("MagicNumber")
public class StartupServletDistTest {
    ...
    private static final Logger LOGGER = Logger.getLogger(StartupServletDistTest.class);
